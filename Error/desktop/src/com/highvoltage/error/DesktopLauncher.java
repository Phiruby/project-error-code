...
public class DesktopLauncher {
	public static void main (String[] arg) {
		...
		config.setTitle("Error = (moreCode)^2");
		config.setWindowSizeLimits(960,540,1600,900);
		...
		//System.out.println(getCodeStringList("codeSpace/posInfo.txt")[0]);
	...
	public static String[] getCodeStringList(String path) {
		String[] codeLines;
		try {
			InputStream is = new FileInputStream(path);
			int fileLength = is.available();
			codeLines = new String[fileLength];
